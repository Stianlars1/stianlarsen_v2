      ...
      <div className={styles.container}>
        ...
        <ul className={styles.featuresList}>
          <li className={styles.feature}>
            Frontend Development: React, Next.js, TypeScript, JavaScript, HTML5,
            CSS3, SCSS
          </li>
          <li className={styles.feature}>
          ...
          <li className={styles.feature}>
            Cloud Services: AWS Lightsail, Google Cloud Storage, Vercel
            deployment
          </li>
          <li className={styles.feature}>
        ...
        <ul className={styles.projectsList}>
          <li className={styles.project}>
            ...
            <span className={styles.projectDescription}>
              Full-stack task management application built with Next.js,
              TypeScript, Kotlin, Spring Boot, and PostgreSQL. Features custom
              JWT authentication, AWS hosting, and Google Cloud integration.
            </span>
          </li>
          <li className={styles.project}>
            <strong className={styles.projectName}>
              Tinify.dev - Advanced Image Optimization Service
            </strong>
            <span className={styles.projectDescription}>
          ...
          <li className={styles.project}>
            ...
            <span className={styles.projectDescription}>
              Free QR code generation platform built with Next.js, TypeScript,
              Supabase, and Tailwind CSS for Norwegian and international users.
            </span>
          </li>
          <li className={styles.project}>
            <strong className={styles.projectName}>
            ...
            <span className={styles.projectDescription}>
              Complete boat rental management system with Firebase backend,
              admin dashboard, inventory management, and customer booking
              system.
            </span>
          </li>
          <li className={styles.project}>
            <strong className={styles.projectName}>
              AudioVisualizer.io - Audio Visualization Platform
            </strong>
            <span className={styles.projectDescription}>
              Online platform for uploading and visualizing audio files with
              React, TypeScript, Node.js, and Wavesurfer.js integration.
            </span>
          </li>
        </ul>
        ...
        <ul className={styles.packagesList}>
          ...
          <li className={styles.package}>
            @stianlarsen/copy-to-clipboard - Modern clipboard utility for web
            applications
          </li>
          <li className={styles.package}>
            @stianlarsen/react-code-preview - Code preview component with syntax
            highlighting
          </li>
          <li className={styles.package}>
        ...
        <p className={styles.description}>
          Available for freelance web development projects, consulting, and
          custom software development. Specializing in full-stack web
          applications, e-commerce platforms, business management systems, and
          modern web development solutions for Norwegian and international
          clients.
        </p>
        ...
        <p className={styles.description}>
          ...
          engineering, web development, and modern programming practices.
          Self-taught in many technologies with passion for continuous learning
        ...
        <p className={styles.description}>
          Expert-level proficiency in TypeScript, JavaScript, React, Next.js,
          HTML5, CSS3, SCSS. Backend development with Kotlin, Spring Boot,
          Node.js, Express.js. Database design and optimization with PostgreSQL,
          Firebase, Supabase. Cloud deployment and DevOps with AWS, Google
          Cloud, Vercel. Version control with Git and GitHub.
        </p>
        ...
        <p className={styles.description}>
          Get in touch for web development projects, collaboration
          opportunities, or professional inquiries. Email: {ME.email} | Phone:{" "}
          {ME.phoneNumberString} | Location: {ME.location} | GitHub:
          https://github.com/Stianlars1 | LinkedIn:
