...
import styles from "./css/gradientBg.module.css";
export const ReactGradientAnimationBackground = ({
  notMountedClass,
  className = "",
}: {
  ...
  const commonProps = {
    ...
    speed: {
      x: {
        min: isMobileSize ? (isDarkmode ? 0.1 : 0.7) : isDarkmode ? 0.2 : 0.9,
  ...
  return (
    <>
      <GradientBackground
        ...
        colors={
          isDarkmode
            ...
            : {
                background: "#953eff",
                particles: ["#2563eb", "#ff681c", "#ff0a53", "#2563eb"],
              }
        }
      />
      ...
      {!hasMounted && notMountedClass && (
        <div
          className={styles.notMountedClass}
